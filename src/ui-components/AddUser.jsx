...
export default function AddUser(props) {
  ...
  const [
    textFieldThreeFourSixThreeTwoSevenThreeFiveValue,
    setTextFieldThreeFourSixThreeTwoSevenThreeFiveValue,
  ] = useStateMutationAction("");
  const [
  ...
  const buttonTwoNineSevenSixSixNineTwoSixOnClick = useDataStoreCreateAction({
    fields: {
      ...
      mobile: textFieldThreeFourSixThreeTwoSevenThreeFiveValue,
      email: textFieldTwoNineSevenSixSixNineTwoFourValue,
    },
    model: User,
    schema: schema,
  });
  const buttonThreeFourSixFourTwoSixNineZeroOnClick = useDataStoreUpdateAction({
    fields: {
      name: textFieldTwoNineSevenSixSixNineTwoTwoValue,
      age: textFieldTwoNineSevenSixSixNineTwoThreeValue,
      mobile: textFieldThreeFourSixThreeTwoSevenThreeFiveValue,
  ...
  return (
    ...
    >
      <Flex
        ...
        backgroundColor="rgba(223,217,241,1)"
      ...
      >
        ...
        >
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeFourSixThreeTwoSevenThreeFiveValue}
            onChange={(event) => {
              setTextFieldThreeFourSixThreeTwoSevenThreeFiveValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField34632735")}
          ></TextField>
        </Flex>
        <Divider
          width="unset"
        ...
        >
          ...
          <Button
            ...
            children="Update"
            onClick={() => {
              buttonThreeFourSixFourTwoSixNineZeroOnClick();
            }}
            {...getOverrideProps(overrides, "Button34642690")}
          ></Button>
        </Flex>
      </Flex>
    </Flex>
